...
sin cambiar la forma en que funciona el programa. Este programa, 
RPN.java es una calculadora de notación inversa polaca que utiliza una pila.
...
(pues no podemos poner los paréntesis para alterar la prioridad)
